...
public class UserServiceImpl implements UserService {
	...
	public int addUser(User user) throws Exception {
		...
		/*
		 * int result = 0;
		 * System.out.println(">>>>> 1 번쩨 insert ====================="); result =
		 * userDao.addUser(user); System.out.println(">>>>> 1 번쩨 insert 결과 : "+result);
		 * System.out.println(">>>>> 2 번쩨 insert ====================="); result =
		 * userDao.addUser(user); System.out.println(">>>>> 2 번쩨 insert 결과 : "+result);
